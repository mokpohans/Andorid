...
public class ORActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oractivity);
        result = findViewById(R.id.or_resultbtn);
        input_1 = false;
        input_2 = false;
        output = false;
        ImageButton num_1 = (ImageButton) findViewById(R.id.or_switchbtn_1) ;
        ImageButton num_2 = (ImageButton) findViewById(R.id.or_switchbtn_2) ;
        ImageButton needex = (ImageButton) findViewById(R.id.or_needex) ;
        ...
        ImageButton.OnClickListener onClickListener = new ImageButton.OnClickListener(){
            ...
            public void onClick(View view){
                switch (view.getId()){
                    case R.id.or_needex:{
                        Intent intent = new Intent(ORActivity.this, ORexplainActivity.class);
                        startActivity(intent);
                        break;

                    }
                    case R.id.or_switchbtn_1:{
                        if(input_1 == false){
